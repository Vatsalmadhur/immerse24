...
export const Heading = (props:Props) => {
  return (
    ...
    <Box className="blueBrdr" width="auto" minWidth="220px" height="75px"  borderRight="5px solid "  display="flex" alignItems="center" justifyContent="start"><Typography variant='h3' className='rubik'>{props.title}</Typography></Box>
